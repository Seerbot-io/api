...
def create_access_token(
    wallet_address: str, extra_claims: Optional[Dict[str, Any]] = None
) -> str:
    """
    ...
    expire_seconds = settings.ACCESS_TOKEN_EXPIRE_SECONDS or 1800
    ...
    return jwt.encode(payload, encode_key, algorithm=algorithm)
