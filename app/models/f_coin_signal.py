...
class FCoinSignal(Base):
    ...
    )  # Note: constraint references open_time, but column is 'time'
...
class FCoinSignal5m(FCoinSignal):
    ...
    __table_args__ = (
        UniqueConstraint(
            "symbol", "time", name="f_coin_signal_5m_symbol_open_time_key"
        ),
        {"schema": "proddb"},
    )
...
class FCoinSignal30m(FCoinSignal):
    ...
    __table_args__ = (
        UniqueConstraint(
            "symbol", "time", name="f_coin_signal_30m_symbol_open_time_key"
        ),
        {"schema": "proddb"},
    )
...
class FCoinSignal1h(FCoinSignal):
    ...
    __table_args__ = (
        UniqueConstraint(
            "symbol", "time", name="f_coin_signal_1h_symbol_open_time_key"
        ),
        {"schema": "proddb"},
    )
...
class FCoinSignal4h(FCoinSignal):
    ...
    __table_args__ = (
        UniqueConstraint(
            "symbol", "time", name="f_coin_signal_4h_symbol_open_time_key"
        ),
        {"schema": "proddb"},
    )
...
class FCoinSignal1d(FCoinSignal):
    ...
    __table_args__ = (
        UniqueConstraint(
            "symbol", "time", name="f_coin_signal_1d_symbol_open_time_key"
        ),
        {"schema": "proddb"},
    )
